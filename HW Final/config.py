...
SRC_DIRECTORY = "/pylon5/mc5fr7p/gexijin/tools/"
...
BOWTIE_DATABASES = {"human":"/pylon5/mc5fr7p/gexijin/tools/imsa-a/human/bowtie/GRCh38_africa"}
BOWTIE_DB_ABBREV = {"human":"hg"}

# BOWTIE2 DATABASES
BOWTIE2_DATABASES = {"human":"/pylon5/mc5fr7p/gexijin/tools/imsa-a/human/bowtie/GRCh37"}
...
BLAT_DATABASES = {"human":"/pylon5/mc5fr7p/gexijin/tools/imsa-a/human/blat/GRCh38_africa.2bit"} 

BLAT_OOC_FILES = {"human":"/pylon5/mc5fr7p/gexijin/tools/imsa-a/human/blat/GRCh38_africa.11.ooc"}
...
BLAST_DATABASES = {"nt":"/pylon5/mc5fr7p/gexijin/tools/imsa-a/microbiome/NCBI.fungiDBselect.genomeonly", 
                   "human":"/pylon5/mc5fr7p/gexijin/tools/imsa-a/human/blast/GRCh37"}
BLAST_DB_ABBREV = {"nt":"nt", "human":"hg", 
                   "humanRNA":"hr", "humanRNA-1":"hr1", "humanRNA-2":"hr2", "humanRNA-3":"hr3",
                   "humanRepeat":"rep"}
BLAST_TAX_DB = "/pylon5/mc5fr7p/gexijin/tools/imsa-a/gi_taxid/gi_taxid_nucl.dmp"
...
PATH_TO_BOWTIE = "/pylon5/mc5fr7p/gexijin/tools/bowtie-1.2.2-linux-x86_64/bowtie"
PATH_TO_BOWTIE2 = "bowtie2"
PATH_TO_BLASTN = "blastn"
PATH_TO_BLAT = "/pylon5/mc5fr7p/gexijin/tools/icebert-pblat-e05e284/pblat"
